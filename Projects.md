...
**Key takeaway**  
Robotics isn't just about building humanoid machines. It's about using sensors and automation to understand the physical world—in this case, keeping water supplies safe.

`#hyperspectral` `#environmental` `#real-time`

---

## 3. 🏗️ SRECMOCOS Project  
**2011 – Present**  
...
## 5. 🧠 Local Memory of a mobile robot based on depth sensors  
**Jun 2011 – Jun 2012**  
...
**Why it matters**  
This is a classic robotics pipeline: Sense (Kinect) → Localize (where am I?) → Map (what's around me?) → Act (follow the person). It’s a hands-on implementation of SLAM (Simultaneous Localization and Mapping) basics.
...
## 6. 🚁 Proyecto ERLE  
**Jun 2012 – Present**  
*Creating a tiny, affordable flying robot—the "Arduino of robotics."*

**What it is**  
A project to build a palm-sized quadcopter (about 10cm in diameter) that costs around €150. It runs Ubuntu, uses standard tech like WiFi and Bluetooth, and is programmable via ROS. It's designed to be accessible to everyone, from students to hobbyists.
...
## 7. 🕷️ Erle-Spider, the Linux legged drone  
**Jun 2015 – Present**  
...
## 9. 🔌 H-ROS: Hardware Robot Operating System  
**Jan 2016 – Present**  
...
**Why it matters**  
Currently, building a robot is like building a computer in the 1980s—you have to wire everything manually and write custom drivers. H-ROS aims to make it like USB: plug in a component, and it just works.
...
These notes are for personal study and reference. All projects are the work of Alejandro Hernandez Cordero and his collaborators. For more details, visit his [LinkedIn profile](https://www.linkedin.com/in/ahcorde/).
